...
public class SetFriends extends Array {
    ...
    public SetFriends(String firstFriend, String secondFriend, String relationship) {
    ...
    public void checkAges() {
        ...
        if (ageOK == true) {
            AddRelationships addRelationship = new AddRelationships();
